		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GIT Test",
									"targetURL": "#khalidpractice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"khalidpractice-display": {
								"semanticObject": "khalidpractice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=khalid.practice",
									"url": sap.ui.require.toUrl("khalid/practice")
								}
							}
						}
					}
